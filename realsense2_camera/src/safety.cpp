...
#ifndef HAVE_RS2_SAFETY_SENSORS
namespace
{
template <typename ResponseT>
void setSafetyUnsupported(ResponseT& res)
{
    res.success = false;
    res.error_message = "Safety sensor API is not supported by this librealsense version.";
}
}
#endif
